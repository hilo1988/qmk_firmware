...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      CC_T(KC_TAB),     KC_Q,     KC_W,    KC_E,    KC_R,                KC_T,                                      KC_Y,         KC_U,                 KC_I,    KC_O,    CC_T(KC_P), KC_ENT, \
      KC_LCTL,          KC_A,     KC_S,    KC_D,    LT(_TEN_KEY, KC_F),  SGUI_T(KC_G),                              SGUI_T(KC_H), LT(_TEN_KEY, KC_J),   KC_K,    KC_L,    KC_SCLN,    KC_QUOT, \
      KC_LSFT,          KC_Z,     KC_X,    KC_C,    KC_V,                KC_B,    KC_LBRC,           KC_RBRC,       KC_N,         KC_M,                 KC_COMM, KC_DOT,  KC_SLSH,    KC_GRV , \
      ADJUST,           KC_LGUI,  KC_LALT, KC_LCTL, EISU,                LOWER,   GUI_T(KC_SPC),     GUI_T(KC_SPC),  RAISE,       KANA,                 KC_LEFT, KC_DOWN, KC_UP,      KC_RGHT \
      ),
  ...
  [_TEN_KEY] = LAYOUT( \
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_1,    KC_2,    KC_3,    KC_UP, KC_GRV , \
        ADJUST,  KC_LGUI,  KC_LALT, KC_LCTL, EISU,    LOWER,   KC_SPC,  KC_SPC, RAISE,   KC_0,    KC_LEFT, KC_LEFT, KC_DOWN,   KC_RGHT \
        ),
